...
public class ExampleProcessingImages {

    public static final String SOURCE_FILE = "./src/main/resources/one-flower.jpeg";
    public static final String DESTINATION_FILE = "./target/new-one-flower.jpeg";
