...
public class ProductReviewsService {
    ...
    private ReentrantReadWriteLock productReviewLock = new ReentrantReadWriteLock();
    private Lock readProductReviewLock = productReviewLock.readLock();
    private Lock writeProductReviewLock = productReviewLock.writeLock();
    ...
    Lock getLockForAddProductReview() {
        // add code here
        return writeProductReviewLock;
    }

    Lock getLockForGetAllProductReviews() {
        // add code here
        return readProductReviewLock;
    }
